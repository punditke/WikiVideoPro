// components/CinematicTheater.js
            ...
            {video.thumbnail ? (
              <div className="relative w-full aspect-video rounded-xl overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 bg-emerald-500/90 backdrop-blur-sm rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform">
                    <div className="w-0 h-0 border-t-[12px] border-t-transparent border-l-[20px] border-l-white border-b-[12px] border-b-transparent ml-1" />
                  </div>
                </div>
              </div>
            ) : (
              <div className="text-zinc-500">Video preview not available</div>
            )}
          </div>

          {/* Asset Intelligence Panel - 30% */}
          <div className="lg:w-[30%] border-l border-white/5 bg-zinc-900/50 overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-black/30 rounded-lg p-4 border border-white/5">
                  ...
                  <dl className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <dt className="font-inter text-xs text-zinc-500">Size</dt>
                      <dd className="font-inter text-xs text-white">
                        {video.size ? `${(video.size / 1024 / 1024).toFixed(2)} MB` : 'Unknown'}
                      </dd>
                    </div>
                    <div className="flex justify-between">
                ...
                {video.description && (
                  <div>
                    <h3 className="font-inter text-sm font-medium text-white mb-2">
                      Description
                    </h3>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <HiOutlineDownload className="w-5 h-5 text-zinc-500 group-hover:text-emerald-400" />
                  </button>
